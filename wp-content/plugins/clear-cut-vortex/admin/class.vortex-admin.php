...
class Vortex_Admin
{
	...
	public static function display_configuration_page()
	{
		...
		echo (self::get_page_url('vortex_channels'));
		// Vortex::log( compact( 'stat_totals', 'akismet_user' ) );
		// Vortex::view( 'config', compact( 'api_key', 'akismet_user', 'stat_totals', 'notices' ) );
